    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                fileName = formData.get('song').name;
                if (!fileName) {
                ...
                return [4 /*yield*/, fetch("http://localhost:3000/albums/songs/".concat(albumId), {
                        method: 'POST',
                        body: formData
                    })];
            case 1:
            ...
            case 4:
                error_1 = _a.sent();
                console.error('Error parsing error response:', error_1);
                return [3 /*break*/, 5];
            case 5: throw new Error("Failed to add song. Status: ".concat(response.status, ", Message: ").concat(errorMessage));
